...
CALL_METHOD = {ConfigConstant.WIDGET_TYPE_CHECK_BOX:'click',
               ConfigConstant.WIDGET_TYPE_BUTTON:'click',
               ConfigConstant.WIDGET_TYPE_LINK:'click',
               ConfigConstant.WIDGET_TYPE_TEXT_BOX:'send_keys',
               ConfigConstant.WIDGET_TYPE_MANU:'click',
               ConfigConstant.WIDGET_TYPE_RADIO:'click'}
